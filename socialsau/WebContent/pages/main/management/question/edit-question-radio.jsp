						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<label class="radio-inline">
									<c:if test="${question.questionAnswer == 'A'}">
										<input type="radio" name="questionAnswers" value="A" class="rdoAnswer" checked> Choice A
									</c:if>
									<c:if test="${question.questionAnswer != 'A'}">
										<input type="radio" name="questionAnswers" value="A" class="rdoAnswer"> Choice A
									</c:if>
								</label>
								<label class="checkbox-inline">
									<c:if test="${question.questionAnswer == 'B'}">
										<input type="radio" name="questionAnswers" value="B" class="rdoAnswer" checked> Choice B
									</c:if>
									<c:if test="${question.questionAnswer != 'B'}">
								...
								<label class="checkbox-inline">
									<c:if test="${question.questionAnswer == 'C'}">
										<input type="radio" name="questionAnswers" value="C" class="rdoAnswer" checked> Choice C
									</c:if>
									<c:if test="${question.questionAnswer != 'C'}">
								...
								<label class="checkbox-inline">
									<c:if test="${question.questionAnswer == 'D'}">
										<input type="radio" name="questionAnswers" value="D" class="rdoAnswer" checked> Choice D
									</c:if>
									<c:if test="${question.questionAnswer != 'D'}">
