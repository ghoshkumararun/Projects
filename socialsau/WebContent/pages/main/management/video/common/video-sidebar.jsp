...
<ul class="nav nav-pills nav-stacked">
	<li class="active"><a href="javascript:void(0)">Video Management</a></li>
	<li class="sau-item"><a href="../video/allVideo?tutorialId=${tutorial.tutorialId}"><span class="glyphicon glyphicon-play-circle"></span> &nbsp;Video Library</a></li>
	<li class="sau-item"><a href="../video/createVideo?tutorialId=${tutorial.tutorialId}"><span class="glyphicon glyphicon-play-circle"></span> &nbsp;Create Video</a></li>
